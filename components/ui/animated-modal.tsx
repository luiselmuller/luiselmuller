...
export const ModalTrigger = ({
  ...
  return (
    <button
      className={cn(
        "px-4 py-2 rounded-md text-center relative overflow-hidden text-slate-200",
        className
      )}
...
export const ModalFooter = ({
  ...
  return (
    <div
      className={cn(
        "flex justify-end p-4 bg-indigo-500 bg-clip-padding backdrop-filter  backdrop-blur bg-opacity-50 backdrop-saturate-100 backdrop-contrast-100 bg-[url('data:image/svg+xml;base64,')] bg-blend-overlay",
        className
      )}
    >
      {children}
